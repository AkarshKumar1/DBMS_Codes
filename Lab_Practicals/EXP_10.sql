...
-- 1. Display the names of employees from department number 10 with salary greater than that of any employee 
...
-- 2. Display the names of employee from department number 10 with salary greater than that of all employee working 
...
-- 7. Display employee name, deptname, salary and comm. For those sal in between 2000 to 5000.
...
-- 10. Display grade and employees name for the dept no 10 or 30 , while joined the company before 31-dec-82.
